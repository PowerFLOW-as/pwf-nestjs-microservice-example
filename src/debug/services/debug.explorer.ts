...
import { DebugLog } from '../decorators/debug-log.decorator';
import type { DebugOptions, Metatype } from '../models/debug.interface';

@Injectable()
export class DebugExplorer {
  private exclude: Set<string> = new Set(['Logger', 'ConfigService']);

  constructor(private discoveryService: DiscoveryService, private reflector: Reflector) {
